...
loaded_model1 = pickle.load(open('cricket_inceptionv3_equal_linsvm_model1.sav', 'rb'))
loaded_model2 = pickle.load(open('cricket_inceptionv3_equal_linsvm_model2.sav', 'rb'))

#Path for the video to be summarized
vidcap = cv2.VideoCapture('testVideo3.mp4')
